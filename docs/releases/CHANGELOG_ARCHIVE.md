...
See the [complete release notes](v0.1.0a2.md).
...
- Added immutable run IDs, interruption handling, linked multi-trial retries,
  worker factories, and integrity checks (`049934d`, `c03996c`).
...
[compatibility notes](../compatibility.md) before the first GPU run.
